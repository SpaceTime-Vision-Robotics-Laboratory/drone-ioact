...
from robobase import ActionsQueue, DataChannel, ThreadGroup, DataProducers2Channels, Actions2Robot
...
def main(args: Namespace):
    ...
    video_data_producer = VideoDataProducer(video_player=video_player)
