...
Moreover, in [basic](basic/) there's generic ones, like a bunch of hello world examples to get to know the library a bit better. These should be pursued first.
